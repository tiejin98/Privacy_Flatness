...
def _get_command(
    ...
    task_name_to_factor = {
        "sst-2": 1, "qnli": 2,"trec": 2, "qqp": 6, "mnli": 6,
    }
    ...
    cmd = f'''
python -m classification.run_classification_pretuning_sparse \
  --task_name {task_name} \
  --data_dir {data_dir} \
  ...
  --per_example_max_grad_norm 0.2 --clipping_mode {clipping_mode} \
