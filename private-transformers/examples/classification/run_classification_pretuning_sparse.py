...
from .src.trainer import Trainer,Trainer_prefix
...
def main():
    ...
    # torch.save(model.prompt_encoder["default"].embedding.weight.data.detach().cpu(),"test_embedding.pt")
    ...
    if training_args.do_train:
        ...
        if privacy_args.non_private:
            print("Non private save")
            torch.save(model.prompt_encoder["default"].embedding.weight.data.detach().cpu(),"test_embedding_non_private_{}_sparse.pt".format(data_args.task_name))
